<!-- Modal 1 - Bootstrap Style -->
<div class="modal first-modal" id="teTermsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content teTerms-modals" style="border: none; border-radius: 8px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);">
            <div class="modal-header" style="border-bottom: 1px solid #f0f0f0; padding: 20px 24px; background-color: #f9fafb; border-radius: 8px 8px 0 0;">
                <h5 class="modal-title" style="font-size: 1.25rem; font-weight: 600; color: #2d3748;">
            ...
            <div class="modal-body" style="padding: 24px; line-height: 1.6; color: #4a5568; font-size: 0.9375rem;">
            ...
            <div class="modal-footer" style="border-top: 1px solid #f0f0f0; padding: 16px 24px; background-color: #f9fafb; border-radius: 0 0 8px 8px;">
                <button class="modal-button btn btn-outline-secondary modal-button-custom modal-close" style="padding: 8px 16px; border-radius: 6px; font-weight: 500; transition: all 0.2s ease;">
